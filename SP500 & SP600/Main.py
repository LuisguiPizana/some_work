...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 30 14:33:32 2020
...
#dc.get_data_from_yahoo(info_dir,sp_small_caps_dir+'/'+pickle_name)
...
"""
#buscamos las acciones que iban bien antes del coronavirus del 3 de junio 2019
#al 31 de enero de 2020
adj_close = gp.crecimiento_en_periodo(adj_close,'2019-06-03','2020-01-31')

adj_close = adj_close.fillna(-999)

cambios = gp.calcula_desc(adj_close,'2020-01-02','2020-12-29')

mejores = gp.selecciona_mejores(cambios,2)
